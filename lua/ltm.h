...
** 'isrealasize'.)
*/
#define maskflags (~(~0u << (TM_EQ + 1))) // 00111111b
...
LUAI_FUNC void luaT_adjustvarargs(lua_State* L, int nfixparams, CallInfo* ci, const Proto* p);
LUAI_FUNC void luaT_getvarargs(lua_State* L, CallInfo* ci, StkId where, int wanted);
