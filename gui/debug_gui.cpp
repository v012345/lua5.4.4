...
int main(int argc, char const *argv[])
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"debug tool", WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, NULL, NULL, wc.hInstance, NULL);
    ...
    while (!done)
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Begin("Hello, world11111111111111111!"); // Create a window called "Hello, world!" and append into it.

            ImGui::Text("This is some useful text.22222222222222"); // Display some text (you can use a format strings too)
